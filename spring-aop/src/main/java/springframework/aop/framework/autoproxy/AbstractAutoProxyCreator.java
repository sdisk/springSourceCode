...
import springframework.aop.framework.AopInfrastructureBean;
import springframework.aop.framework.ProxyFactory;
import springframework.aop.framework.ProxyProcessorSupport;
import springframework.aop.framework.adapter.AdvisorAdapterRegistry;
import springframework.aop.framework.adapter.GlobalAdvisorAdapterRegistry;
import springframework.aop.target.SingletonTargetSource;
...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	public Object postProcessAfterInitialization(@Nullable Object bean, String beanName) {
		if (bean != null) {
			// 构建key 格式：beanClassName_beanName
			Object cacheKey = getCacheKey(bean.getClass(), beanName);
