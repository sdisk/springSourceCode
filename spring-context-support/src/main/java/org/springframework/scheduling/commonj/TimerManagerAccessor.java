...
/**
 * Base class for classes that are accessing a CommonJ {@link TimerManager}
...
public abstract class TimerManagerAccessor extends JndiLocatorSupport
	 ...
	 * @see TimerManager#isSuspending()
	 * @see TimerManager#isStopping()
	 */
	@Override
