 ...
 * CommonJ {@link TimerManager} and exposes it for bean references.
 *
...
public class TimerManagerFactoryBean extends TimerManagerAccessor
	 ...
	 * @see TimerManager#schedule(commonj.timers.TimerListener, long)
	 * @see TimerManager#schedule(commonj.timers.TimerListener, long, long)
	 * @see TimerManager#scheduleAtFixedRate(commonj.timers.TimerListener, long, long)
	 */
